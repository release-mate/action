...
jobs:
  release:
    uses: release-mate/action/.github/workflows/release-please.yml@v1.1.2
    secrets:
...
jobs:
  release:
    uses: your-org/release-tooling/.github/workflows/release-please.yml@v1.1.2
    secrets:
      client-id: ${{ secrets.RELEASE_MATE_CLIENT_ID }}
      app-private-key: ${{ secrets.RELEASE_MATE_PRIVATE_KEY }}
```
...
jobs:
  release:
    ...
    permissions: {}
    steps:
      - uses: release-mate/action@v1.1.2
        with:
          client-id: ${{ secrets.RELEASE_MATE_CLIENT_ID }}
          app-private-key: ${{ secrets.RELEASE_MATE_PRIVATE_KEY }}
```
